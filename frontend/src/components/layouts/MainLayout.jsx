  ...
  return (
    <div className="drawer lg:drawer-open bg-[#F4F4F5]">
      ...
      <div className="drawer-content flex h-dvh flex-col overflow-hidden">
        <nav className="flex w-full shrink-0 items-center justify-between gap-1 border-b border-[#2C3038] bg-[#FFF] p-1">
          <label
            htmlFor="my-drawer-4"
          ...
          <div className="flex items-stretch">
            <div className="dropdown dropdown-end">
              <div
                tabIndex={0}
                role="button"
                className="btn btn-sm mr-3 rounded-full bg-[#2C3038] font-semibold shadow-none hover:bg-black"
              >
                J
              </div>
              <ul
                tabIndex="-1"
                className="menu dropdown-content bg-base-200 z-1 mt-2 w-42 rounded-sm p-2 font-bold shadow-sm"
              >
                <li>
                  <button
                    onClick={logout}
                ...
                <li>
                  <a
                    ...
                    className="flex items-center justify-between rounded-sm"
                  >
                    <span className="font-semibold text-[#FFF]">Settings</span>
                    <Settings size={18} />
                  </a>
                </li>
              </ul>
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        ></label>
        <div className="is-drawer-close:w-16 is-drawer-open:w-60 flex min-h-full flex-col items-start bg-[#2C3038]">
