      ...
      <div className="modal-box bg-white shadow-none rounded-sm">
        ...
        <form onSubmit={handleCreateSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              type="submit"
              className="btn hover:bg-success rounded-sm border-none shadow-none bg-success/80"
            >
              {isCreateLoading ? 'Saving...' : 'Save'}
            </button>
            <button
              type="button"
              className="btn hover:bg-black border-none rounded-sm shadow-none bg-[#2C3038] "
